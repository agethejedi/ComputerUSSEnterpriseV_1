...
export default function TaniaPanel({ isOpen, onClose }) {
  ...
  return (
    <div style={{ position:"fixed", inset:0, zIndex:50, display:"flex", flexDirection:"column", background:"#0a0805", fontFamily:"ui-sans-serif,system-ui,sans-serif" }}>
      ...
      {/* ── Body ── */}
      <div style={{ display:"grid", gridTemplateColumns:`210px 1fr ${canvasOpen?"230px":"0px"}`, flex:1, overflow:"hidden", minHeight:0, transition:"grid-template-columns 0.2s ease", position:"relative", zIndex:1 }}>
        ...
        {/* ── RIGHT: canvas column ── */}
        <div style={{ display:"flex", flexDirection:"column", overflow:"hidden", borderLeft:`0.5px solid rgba(167,139,250,0.15)` }}>
          ...
          <div onClick={() => setCanvasOpen(o => !o)}
            ...
            <span style={{ fontSize:9, letterSpacing:"0.22em", color:"rgba(167,139,250,0.45)" }}>⊞ CANVAS</span>
            <span style={{ marginLeft:"auto", fontSize:7, color:"rgba(167,139,250,0.22)" }}>click or say "open canvas"</span>
            <span style={{ fontSize:8, color:"rgba(167,139,250,0.3)", border:"0.5px solid rgba(167,139,250,0.15)", padding:"1px 6px", borderRadius:2 }}>{canvasOpen?"COLLAPSE":"EXPAND"}</span>
          </div>
